...
def make_crate(output, gen_dir, inputs, srcroot, dep_inputs):
  ...
  output_parent = os.path.dirname(cargo_toml_dir)
  ...
  cargo_f.write('fuchsia-zircon = "*"\n')
  cargo_f.write('tokio-fuchsia = "*"\n')
  cargo_f.write('fidl = "*"\n')

  lib_fn = os.path.join(cargo_toml_dir, 'src', 'lib.rs')
  src_f = file(lib_fn, 'w')
  src_f.write('// Autogenerated by //garnet/public/lib/fidl/build/make_crate.py\n')
  src_f.write('#![deny(warnings)]\n')
  src_f.write('#![deny(missing_debug_implementations)]\n')
  src_f.write('#![allow(unused_imports)]\n')
  src_f.write('#![allow(unused_extern_crates)]\n')
  ...
  inc_fn = os.path.join(output_parent, longname+'.rs')
  inc_f = file(inc_fn, 'w')
  inc_f.write('// Autogenerated by //garnet/public/lib/fidl/build/make_crate.py\n')
  for i in inputs:
    basename = os.path.splitext(os.path.basename(i))[0]
    inc_f.write('mod %s;\n' % basename)
